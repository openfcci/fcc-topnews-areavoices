						...
						<div class="read-share-overlay">
							...
							<div class="share-box-wrapper">
								...
								<div class="read-more-comment">
									<a href="<?php if($postURL != ""){echo $postURL;}else{the_permalink();}; ?>/#comments"><i class="fa fa-comments fa-2"></i></a>
				...
				<div class="content-out">
					<div class="content-in">
						<div id="leader-wrapper" class="left relative">
							<div align="center"><!--Added 08/03/15 to center ads | rveitch | move to options table? -->
								<?php $ad970 = get_option('mvp_header_leader'); if ($ad970) { echo stripslashes($ad970); } ?>
							</div><!--Added 08/03/15 to center ads | rveitch | move to options table? -->
