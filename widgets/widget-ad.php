...
class mvp_ad_widget extends WP_Widget {
	...
	function mvp_ad_widget() {
		...
		/* Create the widget. */
		$this->__construct( 'mvp_ad_widget', __('Top News: Ad Widget', 'mvp_ad_widget'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		/* Hide Sidebar Ads on pages with the 'nativo' name slug [rv] */
		if (!is_page( 'nativo' )) {
			?>
				<div class="widget-ad left relative">
					<div align="center"><!--center ads [rv]-->
